...
public class RecentBlogPostServiceImpl implements RecentBlogPostService {
    ...
    @Autowired
    public RecentBlogPostServiceImpl(BlogPostRepository blogPostRepository, Logger applicationErrorLog) {
    ...
    public ResponseEntity<BlogPosts> recentBlogPosts(int page, int pageSize) {
        try {
            ...
            applicationErrorLog.error("An error has occurred in the RecentBlogPostServiceImpl", e);
